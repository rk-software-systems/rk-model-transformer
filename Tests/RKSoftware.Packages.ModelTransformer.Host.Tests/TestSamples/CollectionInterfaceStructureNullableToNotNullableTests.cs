using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionInterfaceStructureNullableToNotNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionInterfaceStructureNullableToNotNullableTests
{
    #region IList
