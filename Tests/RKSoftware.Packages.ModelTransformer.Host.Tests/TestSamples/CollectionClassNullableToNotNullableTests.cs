using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionClassNullableToNotNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionClassNullableToNotNullableTests
{
    #region List
    ...
    public void TestCreateViewModelToLinkedList()
    {
        var domain = new CompanyDomain
        {
            ProjectLinkedList = new LinkedList<ProjectDomain?>(GetDomains())
        };
    ...
    public void TestUpdateViewModelToLinkedList()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectLinkedList = new LinkedList<ProjectViewModel>(GetViewModels())
        };
    ...
    public void TestCreateViewModelToQueue()
    {
        var domain = new CompanyDomain
        {
            ProjectQueue = new Queue<ProjectDomain?>(GetDomains())
        };
    ...
    public void TestUpdateViewModelToQueue()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectQueue = new Queue<ProjectViewModel>(GetViewModels())
        };
    ...
    public void TestCreateViewModelToStack()
    {
        var domain = new CompanyDomain
        {
            ProjectStack = new Stack<ProjectDomain?>(GetDomains())
        };
    ...
    public void TestUpdateViewModelToStack()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectStack = new Stack<ProjectViewModel>(GetViewModels())
        };
