using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionInterfacePrimitiveNullableToNotNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionInterfacePrimitiveNullableToNotNullableTests
{
    #region IList
    ...
    public void TestCreateViewModelToICollection()
    {
        var domain = new CompanyDomain
        {
            ProjectICollection = [new DateTime(2020, 1, 1), null, new DateTime(2021, 2, 2), new DateTime(2022, 3, 3)]
        };
        ...
        AssertEqualDomainsAndViewModels<DateTime?>(domain.ProjectICollection, viewModel.ProjectICollection.Cast<DateTime?>());
    }
    ...
    public void TestUpdateViewModelToICollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels<DateTime?>(domain.ProjectICollection, viewModel.ProjectICollection.Cast<DateTime?>());
    ...
    public void TestCreateViewModelToIEnumerable()
    {
        ...
        AssertEqualDomainsAndViewModels<int?>(domain.ProjectIEnumerable, viewModel.ProjectIEnumerable.Cast<int?>());
    }
    ...
    public void TestUpdateViewModelToIEnumerable()
    {
        ...
        AssertNotEqualDomainsAndViewModels<int?>(domain.ProjectIEnumerable, viewModel.ProjectIEnumerable.Cast<int?>());
    ...
    public void TestCreateViewModelToIReadOnlyCollection()
    {
        var domain = new CompanyDomain
        {
            ProjectIReadOnlyCollection = [1, null, 2, 3]
        };
        ...
        AssertEqualDomainsAndViewModels<long?>(domain.ProjectIReadOnlyCollection, viewModel.ProjectIReadOnlyCollection.Cast<long?>());
    }
    ...
    public void TestUpdateViewModelToIReadOnlyCollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels<long?>(domain.ProjectIReadOnlyCollection, viewModel.ProjectIReadOnlyCollection.Cast<long?>());
    ...
    public void TestCreateViewModelToIReadOnlyList()
    {
        var domain = new CompanyDomain
        {
            ProjectIReadOnlyList = [1, null, 2, 3]
        };
        ...
        AssertEqualDomainsAndViewModels<byte?>(domain.ProjectIReadOnlyList, viewModel.ProjectIReadOnlyList.Cast<byte?>());
    }
    ...
    public void TestUpdateViewModelToIReadOnlyList()
    {
        ...
        AssertNotEqualDomainsAndViewModels<byte?>(domain.ProjectIReadOnlyList, viewModel.ProjectIReadOnlyList.Cast<byte?>());
