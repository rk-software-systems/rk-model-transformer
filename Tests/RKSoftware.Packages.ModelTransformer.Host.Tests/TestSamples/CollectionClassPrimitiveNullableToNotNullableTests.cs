using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionClassPrimitiveNullableToNotNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionClassPrimitiveNullableToNotNullableTests
{
    #region List
    ...
    public void TestCreateViewModelToCollection()
    {
        ...
        AssertEqualDomainsAndViewModels<int?>(domain.ProjectCollection, viewModel.ProjectCollection.Cast<int?>());
    }
    ...
    public void TestUpdateViewModelToCollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels<int?>(domain.ProjectCollection, viewModel.ProjectCollection.Cast<int?>());
    ...
    public void TestCreateViewModelToLinkedList()
    {
        ...
        AssertEqualDomainsAndViewModels<DateTime?>(domain.ProjectLinkedList, viewModel.ProjectLinkedList.Cast<DateTime?>());
    }
    ...
    public void TestUpdateViewModelToLinkedList()
    {
        ...
        AssertNotEqualDomainsAndViewModels<DateTime?>(domain.ProjectLinkedList, viewModel.ProjectLinkedList.Cast<DateTime?>());
    ...
    public void TestCreateViewModelToReadOnlyCollection()
    {
        ...
        AssertEqualDomainsAndViewModels<long?>(domain.ProjectReadOnlyCollection, viewModel.ProjectReadOnlyCollection.Cast<long?>());
    }
    ...
    public void TestUpdateViewModelToReadOnlyCollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels<long?>(domain.ProjectReadOnlyCollection, viewModel.ProjectReadOnlyCollection.Cast<long?>());
    ...
    public void TestCreateViewModelToQueue()
    {
        var domain = new CompanyDomain
        {
            ProjectQueue = new Queue<byte?>([1, null, 2, 3])
        };
        ...
        AssertEqualDomainsAndViewModels<byte?>(domain.ProjectQueue, viewModel.ProjectQueue.Cast<byte?>());
    }
    ...
    public void TestUpdateViewModelToQueue()
    {
        ...
        AssertNotEqualDomainsAndViewModels<byte?>(domain.ProjectQueue, viewModel.ProjectQueue.Cast<byte?>());
    ...
    public void TestCreateViewModelToStack()
    {
        var domain = new CompanyDomain
        {
            ProjectStack = new Stack<string?>(["p1", null, "p2", "p3"])
        };
