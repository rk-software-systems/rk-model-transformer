using RKSoftware.Packages.ModelTransformer.Host.TestSamples.ArrayPrimitiveNotNullableToNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class ArrayPrimitiveNotNullableToNullableTests
{
    #region Strings
    ...
    public void TestCreateViewModelToArrayOfIntegers()
    {
        ...
        AssertEqualDomainsAndViewModels<int?>(domain.ProjectIds.Cast<int?>(), viewModel.ProjectIds);
    }
    ...
    public void TestUpdateViewModelToArrayOfIntegers()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectIds = [4, null, 5, 6]
        };

        AssertNotEqualDomainsAndViewModels<int?>(domain.ProjectIds.Cast<int?>(), viewModel.ProjectIds);
