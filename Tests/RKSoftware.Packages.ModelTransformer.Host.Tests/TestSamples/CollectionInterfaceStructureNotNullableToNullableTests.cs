using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionInterfaceStructureNotNullableToNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionInterfaceStructureNotNullableToNullableTests
{
    #region IList
