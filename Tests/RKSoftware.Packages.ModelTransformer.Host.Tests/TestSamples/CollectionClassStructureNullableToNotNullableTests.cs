using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionClassStructureNullableToNotNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionClassStructureNullableToNotNullableTests
{
    #region List
