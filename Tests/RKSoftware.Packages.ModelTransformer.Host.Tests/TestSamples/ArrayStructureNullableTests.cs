using RKSoftware.Packages.ModelTransformer.Host.TestSamples.ArrayStructureNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class ArrayStructureNullableTests
{
    [Fact]
    ...
    private static void AssertEqualDomainsAndViewModels(ProjectModel?[] domains, ProjectModel?[] viewModels)
    {
    ...
    private static void AssertNotEqualDomainsAndViewModels(ProjectModel?[] domains, ProjectModel?[] viewModels)
    {
