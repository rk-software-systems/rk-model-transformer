using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionClassPrimitiveNotNullableToNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionClassPrimitiveNotNullableToNullableTests
{
    #region List
    ...
    public void TestCreateViewModelToCollection()
    {
        ...
        AssertEqualDomainsAndViewModels<int?>(domain.ProjectCollection.Cast<int?>(), viewModel.ProjectCollection);
    }
    ...
    public void TestUpdateViewModelToCollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels(domain.ProjectCollection.Cast<int?>(), viewModel.ProjectCollection);
        ...
        AssertEqualDomainsAndViewModels(domain.ProjectCollection.Cast<int?>(), viewModel.ProjectCollection);
    }
    ...
    public void TestCreateViewModelToLinkedList()
    {
        ...
        AssertEqualDomainsAndViewModels(domain.ProjectLinkedList.Cast<DateTime?>(), viewModel.ProjectLinkedList);
    }
    ...
    public void TestUpdateViewModelToLinkedList()
    {
        ...
        AssertNotEqualDomainsAndViewModels(domain.ProjectLinkedList.Cast<DateTime?>(), viewModel.ProjectLinkedList);
    ...
    public void TestCreateViewModelToReadOnlyCollection()
    {
        ...
        AssertEqualDomainsAndViewModels(domain.ProjectReadOnlyCollection.Cast<long?>(), viewModel.ProjectReadOnlyCollection);
    }
    ...
    public void TestUpdateViewModelToReadOnlyCollection()
    {
        ...
        AssertNotEqualDomainsAndViewModels(domain.ProjectReadOnlyCollection.Cast<long?>(), viewModel.ProjectReadOnlyCollection);
    ...
    public void TestCreateViewModelToQueue()
    {
        ...
        AssertEqualDomainsAndViewModels(domain.ProjectQueue.Cast<byte?>(), viewModel.ProjectQueue);
    }
    ...
    public void TestUpdateViewModelToQueue()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectQueue = new Queue<byte?>([4, 5, 6, null])
        };

        AssertNotEqualDomainsAndViewModels(domain.ProjectQueue.Cast<byte?>(), viewModel.ProjectQueue);
    ...
    public void TestUpdateViewModelToStack()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectStack = new Stack<string?>(["p4", "p5", "p6", null])
        };
