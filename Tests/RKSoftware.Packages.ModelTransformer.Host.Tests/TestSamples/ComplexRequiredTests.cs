using RKSoftware.Packages.ModelTransformer.Host.TestSamples.ComplexRequired;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class ComplexRequiredTests
{
    [Fact]
    ...
    public void TestCreateViewModelFromDomainWithNullChild()
    {
        ...
        var exception = Assert.Throws<ArgumentNullException>(() => domain.Transform());
    }
    ...
    public void TestUpdateViewModelFromDomain()
    {
        ...
        Assert.NotNull(updatedViewModel.Industry);
