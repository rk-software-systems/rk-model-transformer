using RKSoftware.Packages.ModelTransformer.Host.TestSamples.CollectionInterfacePrimitiveNullable;

namespace RKSoftware.Packages.ModelTransformer.Host.Tests.TestSamples;

public class CollectionInterfacePrimitiveNullableTests
{
    #region IList
    ...
    public void TestUpdateViewModelToICollection()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectICollection = [new DateTime(2010, 1, 1), new DateTime(2011, 2, 2), new DateTime(2012, 3, 3), null]
        };
    ...
    public void TestUpdateViewModelToIReadOnlyCollection()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectIReadOnlyCollection = [4, 5, 6, null]
        };
    ...
    public void TestUpdateViewModelToIReadOnlyList()
    {
        ...
        var viewModel = new CompanyViewModel
        {
            ProjectIReadOnlyList = [4, 5, 6, null]
        };
